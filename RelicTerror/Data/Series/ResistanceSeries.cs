...
internal static class ResistanceSeries
{
    ...
    // Item-id job order. PLD weapon at base+0, shield at base+17, other jobs at base+offset.
    ...
    private const uint LawsOrderBase    = 2768; // "Quick to Judge: Law's Order <weapon>" - fires on the Augmented stage despite the name.
    ...
    [
        ...
        // Haunting/Vexatious Memories are a once-per-character gate (quest 69575), not a per-weapon cost.
    ...
    // Relic-relevant subset of JournalGenre 91 ("Resistance Weapons" - the genre also spans the
    // Bozja/Zadnor storyline) plus MSQ prerequisite 69218, in progression order.
